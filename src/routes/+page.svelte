...
<div class="flex flex-col gap-y-2.5 h-full">
  ...
  <div class="flex flex-col gap-y-2.5">
    ...
    <h2 class="text-3xl font-bold">Download the answers</h2>
    </div>
    <p>To download the file, click <a href="questions.json" class="underline font-bold" download>here</a>.</p>
  </div>
  <div class="flex flex-col gap-y-2 mt-3.5">
    <div class="flex flex-row gap-x-2.5 items-center">
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-7 h-7">
    ...
    <p>Type the numbers separated by a comma to search for specific questions.</p>
    <div class="join">
  ...
  <div class="flex flex-col gap-y-2 mt-2.5">
    ...
    <div class="flex flex-col md:flex-row gap-x-1.5 md:items-center">
    <p>Is the simulator helpful for you? </p>
    <a class="font-medium italic flex flex-row items-center gap-x-1.5 hover:underline text-blue-700" href="https://www.paypal.com/paypalme/Gabriele3vi"> Offer me a coffee!
      <svg xmlns="http://www.w3.org/2000/svg" class="w-3 h-3" viewBox="0 0 512 512">
        <path stroke="#1D4ED8" d="M432 320H400a16 16 0 0 0 -16 16V448H64V128H208a16 16 0 0 0 16-16V80a16 16 0 0 0 -16-16H48A48 48 0 0 0 0 112V464a48 48 0 0 0 48 48H400a48 48 0 0 0 48-48V336A16 16 0 0 0 432 320zM488 0h-128c-21.4 0-32.1 25.9-17 41l35.7 35.7L135 320.4a24 24 0 0 0 0 34L157.7 377a24 24 0 0 0 34 0L435.3 133.3 471 169c15 15 41 4.5 41-17V24A24 24 0 0 0 488 0z"/>
      </svg>
    </a>
    </div>
    ...
    <p class="text-sm font-bold">NB: Answers are updated to the correction of 5/12</p>
